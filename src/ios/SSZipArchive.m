...
#pragma mark - Zipping
+ (BOOL)createZipFileAtPath:(NSString *)path withFilesAtPaths:(NSArray *)paths  withFilesNames:(NSArray*)names
{
    BOOL success = NO;
    ...
    if ([zipArchive open]) {
        ...
        for (NSString *filePath in paths) {
            ...
            [zipArchive writeFileAtPath:filePath withFileName:zipFileName withPassword:nil];
            i++;
        }
